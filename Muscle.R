...
#   Human Skeletal Muscle Myoblasts (Trajectory)
################################################
...
#load RNA seq data
setwd("~/Desktop/Stanford/Data/Single-cell-traj/mESC-differentiation_hayashi")
...
setwd("~/Dropbox/Eric-Rong-James/ensemble-visual/Figures/traj")
